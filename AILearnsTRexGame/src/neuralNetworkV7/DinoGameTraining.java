...
public class DinoGameTraining extends JPanel implements KeyListener, Runnable { 
  ...
  //Objects
    ...
    public void updateGame() {
    	...
    	//this will stop the system from stalling as it would if i relied off of score 
        ...
        while (it.hasNext()) {
            ...
            for(dinoPlayer d : dinoStorage) {
            	if (d.isAlive == true && obs.intersects(new Rectangle((int) dinoX, (int) d.dinoY, DINO_WIDTH, DINO_HEIGHT))) {
                    d.isAlive = false;
                    livingCount--;
            	}
            }
