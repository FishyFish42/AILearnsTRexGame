...
public class DinoGame extends JPanel implements KeyListener, Runnable { 
    ...
    private static final int FPS = 700;
    ...
    public List<Double> data = Arrays.asList(isJumping, isCrouching, velocityX, dist1, dist2); 
    ...
    public void run() {//when gameThread is started, this is the method that is called
		...
		while(gameThread != null) {
			...
			if(delta>= 1) {	
				...
				util.connector(this, this.gameOver);
    ...
    public void updateGame() {
        ...
        if (obstacles.isEmpty() || obstacles.get(obstacles.size() - 1).x < WIDTH - 150) {
            ...
            obstacles.add(new Rectangle(WIDTH + edist, GROUND_Y - height, OBSTACLE_WIDTH, height));
        }
